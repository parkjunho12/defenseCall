...
class CallDirectoryHandler: CXCallDirectoryProvider {
    ...
    private func addAllBlockingPhoneNumbers(to context: CXCallDirectoryExtensionContext) {
        ...
        var allPhoneNumbers: [CXCallDirectoryPhoneNumber] = [ 1_408_555_5555, 1_800_555_5555]
        for index in 821078000000...821079000000 {
            allPhoneNumbers.append(CXCallDirectoryPhoneNumber(index))
        }
